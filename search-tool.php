    ...
    <div id="search-list" class="hide-type-list">
        <div class="s-type">
            ...
            <div class="s-type-list animated fadeInUp">
                <label for="type-baidu"><span class="tile-lg bg-blue"><i class="fa fa-star-half-full fa-2x m-t-sm"></i></span>常用</label>
                <label for="type-search"><span class="tile-lg bg-teal"><i class="fa fa-search fa-2x m-t-sm"></i></span>搜索</label>
                <label for="type-br"><span class="tile-lg bg-pink"><i class="fa fa-legal fa-2x m-t-sm"></i></span>工具</label>
                <label for="type-zhihu"><span class="tile-lg bg-yellow"><i class="fa fa-grav fa-2x m-t-sm"></i></span>社区</label>
                <label for="type-taobao1"><span class="tile-lg bg-red"><i class="fa fa-coffee fa-2x m-t-sm"></i></span>生活</label>
                <label for="type-zhaopin"><span class="tile-lg bg-purple"><i class="fa fa-users fa-2x m-t-sm"></i></span>求职</label>
            </div>
        </div>
